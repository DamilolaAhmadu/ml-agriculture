...
A farmer reached out to you as a machine learning expert for assistance in selecting the best crop for his field. They hve provided you with a dataset called `soil_measures.csv`, which contains:

...
Some farmers reached out to you as a machine learning expert for assistance in selecting the best crops for their field. They have provided you with a data set called `soil_measures.csv`, which contains:

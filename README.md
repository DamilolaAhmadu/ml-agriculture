...
S farmer reached out to you as a machine learning expert for assistance in selecting the best crops for her field. They have provided you with a data set called `soil_measures.csv`, which contains:

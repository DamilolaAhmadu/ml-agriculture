...
## Introduction
Measuring essential soil metrics such as nitrogen, phosphorous, potassium levels, and pH value is an important aspect of assing soil condition. However, it can also be an expensive and time-consuming process, which results in farmers prioritizing which metrics to measure based on their budget constraints.
